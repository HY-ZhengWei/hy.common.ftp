 ...
 */
public class DefaultFTPEvent extends FTPEvent 
{
	...
	public DefaultFTPEvent(Object i_Source) 
	{
		super(i_Source);
	}
	...
	public DefaultFTPEvent(Object i_Source ,long i_FileSize) 
	{
